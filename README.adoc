...
* For versions 1.3.6 and older, see the link:https://github.com/jenkinsci/conditional-buildstep-plugin/blob/conditional-buildstep-1.5.0/CHANGELOG.adoc[legacy CHANGELOG].
